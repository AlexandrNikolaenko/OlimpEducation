...
function AddUser () {
    ...
    return (
        <div className='flex flex-col gap-y-5'>
            ...
            <form className={`flex flex-col gap-y-5 px-7 ${isOpen ? 'h-auto' : 'h-0 overflow-hidden'} items-end`} id={'add-user-form'} onSubmit={function (e)  {
                    e.preventDefault();
...
function ShowAllUsers () {
    ...
    return (
        <div className='flex flex-col gap-y-5'>
            <div className='flex justify-between items-center'>
                <button className='w-full text-left'>Показать всех пользователей</button>
            </div>
        </div>
    )
}
