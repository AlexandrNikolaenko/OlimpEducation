...
export default function ChoiceAndTasks(){
    ...
    if (window.innerWidth > 1145) {
        return (
            ...
            <section id='choice-section' className="flex h-screen py-[100px] items-center border-b-light-main border-b-[1px] bg-top bg-no-repeat bg-cover bg-fixed" style={{backgroundImage: 'url(SecondFon.png)'}}>
                ...
                <div className="bg-gradient-to-r from-bright to-medium w-60 h-[30px] flex justify-around items-center rounded-full">
                    {choiceLevel != 1 ? <button className="font-serif rounded-full bg-transparent transition-colors duration-300 w-[60px] h-[30px] py-0" onClick={() => {otherCriteria.hardLevel = 1; setChoiceLevel(1)}}>1</button> : <button className="font-serif rounded-full bg-light-main transition-colors duration-300 w-full h-[30px] py-1 px-1 " onClick={() => {otherCriteria.hardLevel = 0; setChoiceLevel(0)}}>1</button>}
                    {choiceLevel != 2 ? <button className="font-serif rounded-full bg-transparent transition-colors duration-300 w-[60px] h-[30px] py-0" onClick={() => {otherCriteria.hardLevel = 2; setChoiceLevel(2)}}>2</button> : <button className="font-serif rounded-full bg-light-main transition-colors duration-300 w-full h-[30px] py-1 px-1 " onClick={() => {otherCriteria.hardLevel = 0; setChoiceLevel(0)}}>2</button>}
                    {choiceLevel != 3 ? <button className="font-serif rounded-full bg-transparent transition-colors duration-300 w-[60px] h-[30px] py-0" onClick={() => {otherCriteria.hardLevel = 3; setChoiceLevel(3)}}>3</button> : <button className="font-serif rounded-full bg-light-main transition-colors duration-300 w-full h-[30px] py-1 px-1 " onClick={() => {otherCriteria.hardLevel = 0; setChoiceLevel(0)}}>3</button>}
                </div>
                ...
                <div className="wrapper mx-auto flex flex-col px-0 max-[1280px]:px-5">
                    ...
                    <div className="w-full flex flex-col gap-5 max-[400px]:gap-2.5">
                        ...
                        <div className="rounded-[10px] overflow-hidden w-max flex flex-nowrap gap-[2px]">
                            {choiceClass != 8 ? <button className='font-serif font-normal px-[15px] py-[4px] bg-bright transition-colors duration-500 hover:bg-light-main text-xs max-[340px]:px-[10px]' onClick={() => {otherCriteria.class = 8; setChoiceClass(8)}}>8 класс</button> : <button className='font-serif text-xs font-normal px-[15px] py-1 bg-light-main max-[340px]:px-[10px]' onClick={() => {otherCriteria.class = 0; setChoiceClass(0)}}>8 класс</button>}
                            {choiceClass != 9 ? <button className='font-serif font-normal px-[15px] py-[4px] bg-bright transition-colors duration-500 hover:bg-light-main text-xs max-[340px]:px-[10px]' onClick={() => {otherCriteria.class = 9; setChoiceClass(9)}}>9 класс</button> : <button className='font-serif text-xs font-normal px-[15px] py-1 bg-light-main max-[340px]:px-[10px]' onClick={() => {otherCriteria.class = 0; setChoiceClass(0)}}>9 класс</button>}
                            {choiceClass != 10 ? <button className='font-serif font-normal px-[15px] py-[4px] bg-bright transition-colors duration-500 hover:bg-light-main text-xs max-[340px]:px-[10px]' onClick={() => {otherCriteria.class = 10; setChoiceClass(10)}}>10 класс</button> : <button className='font-serif text-xs font-normal px-[15px] py-1 bg-light-main max-[340px]:px-[10px]' onClick={() => {otherCriteria.class = 0; setChoiceClass(0)}}>10 класс</button>}
                            {choiceClass != 11 ? <button className='font-serif font-normal px-[15px] py-[4px] bg-bright transition-colors duration-500 hover:bg-light-main text-xs max-[340px]:px-[10px]' onClick={() => {otherCriteria.class = 11; setChoiceClass(11)}}>11 класс</button> : <button className='font-serif text-xs font-normal px-[15px] py-1 bg-light-main max-[340px]:px-[10px]' onClick={() => {otherCriteria.class = 0; setChoiceClass(0)}}>11 класс</button>}
                        </div>
                        <p className="font-sans text-sm/[25px] tracking-[0.02em]">Выберите сложность</p>
                        <div className="bg-gradient-to-r from-bright to-medium w-60 h-[30px] flex justify-around items-center rounded-full">
                            {choiceLevel != 1 ? <button className={`font-serif rounded-full w-[60px] bg-transparent transition-all duration-300 h-[30px] py-0`} onClick={() => {otherCriteria.hardLevel = 1; setChoiceLevel(1)}}>1</button> : <button className={`font-serif rounded-full w-full bg-light-main transition-all duration-300 h-[30px] py-1 px-1 `} onClick={() => {otherCriteria.hardLevel = 0; setChoiceLevel(0)}}>1</button>}
                            {choiceLevel != 2 ? <button className={`font-serif rounded-full w-[60px] bg-transparent transition-all duration-300 h-[30px] py-0`} onClick={() => {otherCriteria.hardLevel = 2; setChoiceLevel(2)}}>2</button> : <button className="font-serif rounded-full w-full bg-light-main transition-all duration-300 h-[30px] py-1 px-1 " onClick={() => {otherCriteria.hardLevel = 0; setChoiceLevel(0)}}>2</button>}
                            {choiceLevel != 3 ? <button className={`font-serif rounded-full w-[60px] bg-transparent transition-all duration-300 h-[30px] py-0`} onClick={() => {otherCriteria.hardLevel = 3; setChoiceLevel(3)}}>3</button> : <button className="font-serif rounded-full w-full bg-light-main transition-all duration-300 h-[30px] py-1 px-1 " onClick={() => {otherCriteria.hardLevel = 0; setChoiceLevel(0)}}>3</button>}
                        </div>
        ...
        return (
            <>
            <section id='choice-section' className="flex  py-[30px] items-center border-b-light-main border-b-[1px] bg-top bg-no-repeat bg-cover bg-fixed" style={{backgroundImage: 'url(SecondFon.png)'}}>
                <div className="wrapper mx-auto flex items-center px-0 max-[1280px]:px-5">
                        ...
                        <div className="flex justify-between gap-2">
                            <div className="flex flex-col justify-between h-[285px]">
                                <div className="flex flex-col gap-y-2.5">
                                    ...
                                    <div className="rounded-[10px] overflow-hidden w-max flex gap-[2px]">
                                        {choiceClass != 8 ? <button className='font-serif font-normal bg-bright transition-colors duration-500 hover:bg-light-main text-sm px-5 py-[6px]' onClick={() => {otherCriteria.class = 8; setChoiceClass(8)}}>8 класс</button> : <button className='font-serif font-normal bg-light-main text-sm px-5 py-[6px]' onClick={() => {otherCriteria.class = 0; setChoiceClass(0)}}>8 класс</button>}
                                        {choiceClass != 9 ? <button className='font-serif font-normal bg-bright transition-colors duration-500 hover:bg-light-main text-sm px-5 py-[6px]' onClick={() => {otherCriteria.class = 9; setChoiceClass(9)}}>9 класс</button> : <button className='font-serif font-normal bg-light-main text-sm px-5 py-[6px]' onClick={() => {otherCriteria.class = 0; setChoiceClass(0)}}>9 класс</button>}
                                        {choiceClass != 10 ? <button className='font-serif font-normal bg-bright transition-colors duration-500 hover:bg-light-main text-sm px-5 py-[6px]' onClick={() => {otherCriteria.class = 10; setChoiceClass(10)}}>10 класс</button> : <button className='font-serif font-normal bg-light-main text-sm px-5 py-[6px]' onClick={() => {otherCriteria.class = 0; setChoiceClass(0)}}>10 класс</button>}
                                        {choiceClass != 11 ? <button className='font-serif font-normal bg-bright transition-colors duration-500 hover:bg-light-main text-sm px-5 py-[6px]' onClick={() => {otherCriteria.class = 11; setChoiceClass(11)}}>11 класс</button> : <button className='font-serif font-normal bg-light-main text-sm px-5 py-[6px]' onClick={() => {otherCriteria.class = 0; setChoiceClass(0)}}>11 класс</button>}
                                    </div>
            ...
            <section id='data-section' className="wrapper mx-auto py-[60px] bg-local min-h-screen bg-center bg-no-repeat flex flex-col  gap-y-4 px-5" style={{backgroundImage: 'url(ThirdFon.png)'}}>
